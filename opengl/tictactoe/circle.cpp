...
void CCircle::Generate(int vertex_size, int* stride, float** vertices, int* size, int* count)
{
    int i, k, n, allocsize;
...
void CCircle::Create(GLuint handle)
{
    float* vertices = NULL;
...
void CCircle::Destroy()
{
    glDeleteVertexArrays(1, &vao);
}

void CCircle::Draw(float* matrix)
{
