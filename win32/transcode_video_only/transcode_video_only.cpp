...
// transcode video file into a mp4 video file

#include "framework.h"
#include "transcode_video_only.h"
...
int APIENTRY wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
    ...
    LoadStringW(hInstance, IDC_TRANSCODEVIDEOONLY, szWindowClass, MAX_LOADSTRING);
    ...
    wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_TRANSCODEVIDEOONLY));
    wcex.hCursor = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground = (HBRUSH)(COLOR_WINDOW + 1);
    wcex.lpszMenuName = MAKEINTRESOURCEW(IDC_TRANSCODEVIDEOONLY);
    ...
    HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_TRANSCODEVIDEOONLY));
