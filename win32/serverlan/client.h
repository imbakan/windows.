...
private:
    ...
    static const int GET_LONGLONG_1 = 3104;
    static const int GET_LONGLONG_2 = 3105;
    static const int GET_STRING = 3106;
    static const int GET_CLIENT = 3107;
    ...
    void OnGetLongLong(char* buffer, int* index, CQueue_i* order, int* next, long long* value, int datatype);
